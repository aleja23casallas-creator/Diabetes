...
"""📊 Histograma / KDE de variables numéricas
...
print("Número de filas:", X_reduced_df.shape[0])
print("Número de columnas:", X_reduced_df.shape[1])
print("Índices iguales?", X_reduced_df.index.equals(y_train.index))

"""# Análisis de los resultados obtenidos en MCA y PCA
